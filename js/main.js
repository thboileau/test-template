...
const apis = Array.prototype.slice.call(document.querySelectorAll('[data-api]'));
apis.forEach(function (api) {
  api.addEventListener('click' , function(event) {
    const currentApi = api.parentElement.querySelector('.dropdown__item--selected');
    const currentTarget = document.querySelector(currentApi.getAttribute('href'));
    currentTarget.hidden = !currentTarget.hidden;
    const target = document.querySelector(api.getAttribute('href'));
